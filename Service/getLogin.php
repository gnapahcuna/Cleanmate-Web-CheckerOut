...
where acc.Username='".$user."' AND acc.Password='".$password."' and AccoutType=1
and ProgramName='Web_checker_out'";
...
where acc.Username='".$user."' AND acc.Password='".$password."' and AccoutType=1 and ProgramName='Web_checker_out'";
